...
export default function Home() {
  return (
    <div className="relative h-screen w-full overflow-hidden">
      {/* Simple gradient background instead of ParticleNetwork */}
      <div className="fixed inset-0 -z-10 bg-gradient-to-b from-blue-50 to-slate-100 dark:from-slate-900 dark:to-slate-800"></div>
