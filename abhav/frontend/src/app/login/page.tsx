          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
              />
              {fieldErrors.username && <p className="text-sm text-red-500 dark:text-red-400">{fieldErrors.username}</p>}
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                required
              />
              {fieldErrors.password && <p className="text-sm text-red-500 dark:text-red-400">{fieldErrors.password}</p>}
            </div>
